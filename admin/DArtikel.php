...
?>
    <tr>
      ...
      <td><button type='button' class='btn btn-outline-primary'><a style='text-decoration: none; color:#465771;' href='updateArt.php?id_art=<?=$d["id_art"]?>'>Edit</a></button></td>
        <td><button type='button' class='btn btn-outline-danger'><a style='text-decoration: none;color:#ce3046;' onclick="return confirm('Apakah anda yakin?');" href='hapus.php?id_art=<?=$d["id_art"]?>'>Hapus</a></button></td>
    </tr>
<?php
}
?>
