...
?>
    <tr>
      ...
      <td><button type='button' class='btn btn-outline-primary'><a style='text-decoration: none; color:#465771;' href='update.php?id_dokter=<?=$d["id_dokter"]?>'>Edit</a></button></td>
        <td><button type='button' class='btn btn-outline-danger'><a style='text-decoration: none;color:#ce3046;' onclick="return confirm('Apakah anda yakin?');" href='hapus.php?id_pesanan=<?=$d["id_pesanan"]?>&id_jadwal=<?=$d["id_jadwal"]?>'>Selesai</a></button></td>
    </tr>
<?php
}
?>
