  ...
  <div style="bottom:10px; right:10px" id="toasts" class="position-fixed d-flex flex-column align-items-end"></div>
          ...
          <ul class="navbar-nav text-center d-flex align-items-center">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="tombol dropdown-item" href="#">Identifikasi Masalah Anda</a></li>
              </ul>
            </li>
            ...
            <li class=" ms-2 nav-item">
              <a class="nav-link active text-dark" aria-current="page" href="#ftr">Tentang Kami</a>
            </li>
            <li class=" ms-2 nav-item">
    ...
    <div class=" ms-5 row mt-5">
      <div class="ms-5 col col-md-5 mt-5">
        ...
        <a href="daftar.php"><button style="border-radius: 12px!important;" class="btn mt-2 btn-dark bg-dark text-light pt-3 pb-3 ps-5 pe-5">Gabung Sekarang</button></a>
      </div>
    ...
    <br><br><br>
      ...
      <!-- Footer -->
      <div class="px-3 pb-5 footer" id="ftr" style="background-color: #182831!important;" style="bottom: 10px; right: 10px;">
        <div class="container">
          <div class="row ">
