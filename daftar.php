    ...
    <div class="container d-flex align-items-center justify-content-center" style="height: 100%;">
        <div id="daftar" class="row shadow-lg h-75 mx-auto d-flex align-items-center justify-content-center" style="border-radius: 15px; width: 80vw;background-image: url(gambar/bg2.jpg); background-size: cover;">
            ...
            <div class="col ms-5">
                ...
                <p class="mt-3"><a class="link-underline-dark mt-5 ms-5 text-dark text-center" href="login.php">Saya Sudah Punya Akun</a><a class="link-underline-dark mt-5 ms-5 text-dark text-center" href="index.php">Menu utama</a></p>
            </div>
    </div>
      <!-- Footer -->
