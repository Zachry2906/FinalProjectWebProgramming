...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Nov 2023 pada 17.31
...
CREATE TABLE `artikel` (
  ...
  `gambar_art` varchar(111) NOT NULL,
  `desk_art` varchar(111) NOT NULL,
...
INSERT INTO `artikel` (`id_art`, `gambar_art`, `desk_art`, `link`) VALUES
(1, 'art1.png', 'Kesehatan jiwa atau sebutan lainnya kesehatan mental adalah kesehatan yang berkaitan dengan kondisi emosi, keji', 'https://www.halodoc.com/kesehatan/kesehatan-mental'),
(2, 'art2.png', 'Menjaga kesehatan fisik itu sama pentingnya dengan menjaga kesehatan mental. Perlu dipahami, gangguan kesehatan', 'https://www.halodoc.com/artikel/ini-ciri-ciri-seseorang-mengalami-gangguan-kesehatan-mental'),
(3, 'art3.png', 'Saat seseorang mengalami gangguan mental, banyak yang merekomendasikan untuk menemui psikolog atau psikiater. N', 'https://www.halodoc.com/artikel/ini-perbedaan-psikiater-dan-psikolog-dalam-mengatasi-gangguan-mental'),
(4, 'art4.png', 'nferiority complex atau kompleks inferioritas adalah kondisi ketika seseorang memiliki perasaan rendah diri. Pe', 'https://www.halodoc.com/artikel/mengenal-inferiority-complex-penyebab-gejala-dan-cara-mengatasinya'),
(5, 'art5.png', 'OCD dan OCPD merupakan jenis gangguan mental yang berdampak pada pola pikir pengidapnya. Perbedaan keduanya bis', 'https://www.halodoc.com/artikel/perlu-tahu-ini-bedanya-gangguan-ocd-dan-ocpd'),
(6, 'art6.png', 'Gangguan kontrol impuls adalah suatu kondisi ketika seseorang memiliki kesulitan mengendalikan emosi atau peril', 'https://www.halodoc.com/artikel/6-penyakit-mental-yang-termasuk-dalam-gangguan-kontrol-impuls');
...
INSERT INTO `user` (`rek_medis`, `password`, `nama_user`, `email`, `tanggal_lahir`, `foto`) VALUES
(123220016, 'user', 'Andrea Alfian', 'bcs@gmail.com', '2004-08-18', 'foto.png'),
(123220077, 'user', '4444', '123220077@student.upnyk.ac.id', '2023-11-03', '6564c3596c304.jpg');
...
--
ALTER TABLE `artikel`
  MODIFY `id_art` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
